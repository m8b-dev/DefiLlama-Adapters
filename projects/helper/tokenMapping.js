...
const fixBalancesTokens = {
  ...
  defichain_evm: {
    ...
    [ADDRESSES.defichain_evm.DUSD]: {
      coingeckoId: "decentralized-usd",
      decimals: 18,
    },
    "0x66F3Cf265D2D146A0348F6fC67E3Da0835e0968E": {
      coingeckoId: "javsphere",
      decimals: 18,
    },
  },
  ace: {
  ...
  scroll: {
    [ADDRESSES.mode.STONE]: {
      coingeckoId: "ethereum:0x7122985656e38bdc0302db86685bb972b145bd3c",
      decimals: 0,
    },
  ...
  sanko: {
    ...
    "0x754cdad6f5821077d6915004be2ce05f93d176f8": {
      coingeckoId: "wrapped-dmt",
      decimals: 18,
    },
    "0xe01e3b20c5819cf919f7f1a2b4c18bbfd222f376": {
      coingeckoId: "sanko-bridged-weth-sanko",
      decimals: 18,
    },
    "0x13d675bc5e659b11cfa331594cf35a20815dcf02": {
      coingeckoId: "sanko-bridged-usdc-sanko",
      decimals: 6,
    },
    "0x3c84f959f4b8ca0c39847d02f936e13fa8fc4eb9": {
      coingeckoId: "beat-the-allegations",
      decimals: 18,
    }, // star
  },
  xai: {
  ...
  ailayer: {
    ...
    "0xc5ed6c946cdc82f4599f0f2f012e1822502e70e3": {
      coingeckoId: "artificial-neural-network-ordinals",
      decimals: 18,
    },
...
for (const [chain, mapping] of Object.entries(coreAssets))
  coreAssets[chain] = Object.values(mapping).map((i) =>
    stripTokenHeader(i, chain),
  );
...
function getCoreAssets(chain = "ethereum") {
  ...
  if (ibcChains.includes(chain))
    addresses.push(...coreAssets.ibc.map((i) => "ibc/" + i));
  if (anyswapTokenBlacklist[chain])
    addresses = addresses.filter(
      (i) => !anyswapTokenBlacklist[chain].includes(i),
    );
  return addresses;
}
...
const anyswapTokenBlacklist = {
  ...
  velas: [ADDRESSES.moonriver.ETH, ADDRESSES.moonriver.USDC],
  dogechain: [
    ADDRESSES.moonriver.USDT,
    ADDRESSES.dogechain.BUSD,
  ...
  wemix: [ADDRESSES.boba.BUSD, ADDRESSES.shiden.ETH, ADDRESSES.moonriver.USDC],
  eos_evm: [
    ADDRESSES.syscoin.USDT,
    ADDRESSES.shiden.ETH,
    ADDRESSES.telos.ETH,
